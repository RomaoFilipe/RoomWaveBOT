const sections: Record<string,string[]> = {
  moderacao: ["🛡️ MODERAÇÃO IMVU", "!avisar @nome motivo — aviso público com histórico", "!expulsar @nome motivo — expulsão da sala atual", "Só dono e moderadores reais da sala. Intervalo: 5 segundos.", "Dono, moderadores e bot estão protegidos."],
